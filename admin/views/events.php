...
$schedulelens_show_core  = ! isset( $schedulelens_settings['show_core'] ) || 1 === (int) $schedulelens_settings['show_core'];
...
<form method="get" class="schedulelens-filters">
	...
	<select name="filter" onchange="this.form.submit()">
		<?php
		foreach ( array(
			'all' => __( 'All', 'schedulelens-cron-viewer' ),
			'overdue' => __( 'Overdue', 'schedulelens-cron-viewer' ),
			'core' => __( 'Core', 'schedulelens-cron-viewer' ),
			'custom' => __( 'Custom', 'schedulelens-cron-viewer' ),
		) as $schedulelens_k => $schedulelens_label ) {
